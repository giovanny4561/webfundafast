  ...
  return (
    <>
      <HeroSection
        ...
        subtitle="Únete al equipo que impulsa el desarrollo de los tenderos colombianos."
      />
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm sm:p-12">
            <div className="mb-6 inline-flex rounded-xl bg-ff-blue/10 p-3">
              <Briefcase className="h-8 w-8 text-ff-blue" />
            </div>

            <h2 className="text-3xl font-bold text-ff-text">
              Vacante: {VACANCY.title}
            </h2>

            <div className="mt-3 flex items-center gap-2 text-ff-text-muted">
              <MapPin className="h-4 w-4" />
              <span>{VACANCY.locations}</span>
            </div>

            <div className="mt-8">
              <h3 className="mb-4 text-lg font-bold text-ff-text">
              ...
              <ul className="space-y-3">
                {VACANCY.requirements.map((req) => (
                  <li key={req} className="flex items-start gap-3">
                    ...
                    <span className="text-ff-text-muted">{req}</span>
                  </li>
                ))}
              </ul>
            </div>

            <div className="mt-10 rounded-xl bg-ff-surface p-6">
              <h3 className="mb-4 text-lg font-bold text-ff-text">
                Información y Postulación
              </h3>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <Mail className="h-4 w-4 text-ff-blue" />
                  <a
                    href={`mailto:${VACANCY.contact.email}?subject=Aplicaci%C3%B3n%20Analista%20de%20Cr%C3%A9dito`}
                    className="text-ff-blue hover:underline"
                  >
                    {VACANCY.contact.email}
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="h-4 w-4 text-ff-blue" />
                  <a
